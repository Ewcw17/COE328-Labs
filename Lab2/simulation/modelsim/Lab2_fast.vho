...
-- x2	=>  Location: PIN_C13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- x4	=>  Location: PIN_D13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \inst8~0_combout\ = (\x4~combout\ & ((\x1~combout\ $ (\x2~combout\)) # (!\x3~combout\))) # (!\x4~combout\ & ((\x1~combout\ & (\x2~combout\)) # (!\x1~combout\ & ((\x3~combout\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110111111011000",
...
-- pragma translate_on
PORT MAP (
	datain => \ALT_INV_inst8~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
